...
// Copy of Create.foundation.utility.Lang but with this mod's namespace
public class Lang {
    /**
    ...
    public static MutableComponent translateDirect(String key, Object... args) {
        return Components.translatable(AdvancedSchedules.MODID + "." + key, resolveBuilders(args));
    }
    ...
    public static LangBuilder builder() {
        return new LangBuilder(AdvancedSchedules.MODID);
    }
